/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/gitlab-runner/riscv-gnu-toolchain/riscv-gnu-toolchain/riscv-gcc/gcc/config/riscv/riscv.md'.  */
...
extern int lc_register_operand (rtx, machine_mode);
extern int le_register_operand (rtx, machine_mode);
extern int ls_register_operand (rtx, machine_mode);
extern int permute_sel_operand (rtx, machine_mode);
extern int const_arith_operand (rtx, machine_mode);
extern int arith_operand (rtx, machine_mode);
extern int arith_operand_opt_imm (rtx, machine_mode);
...
extern int arith_operand_short_imm (rtx, machine_mode);
extern int arith_operand_short_uimm (rtx, machine_mode);
...
extern int vec_comparison_operator (rtx, machine_mode);
extern int reg_or_sci_const (rtx, machine_mode);
extern int reg_or_sciu_const (rtx, machine_mode);
extern int splittable_const_int_operand (rtx, machine_mode);
extern int nonimmediate_operand_exclude_post (rtx, machine_mode);
...
extern int signed_order_operator_wo_eq_ne (rtx, machine_mode);
extern int order_operator_eq_ne (rtx, machine_mode);
extern int order_operator_wo_eq_ne (rtx, machine_mode);
...
extern int tiny_memory_operand (rtx, machine_mode);
extern int tiny_ref_operand (rtx, machine_mode);
extern int tiny_ref_operand_expr (rtx, machine_mode);
extern int riscv_stack_push_operation (rtx, machine_mode);
extern int riscv_stack_pop_operation (rtx, machine_mode);
extern int pop_return_value_constant (rtx, machine_mode);
