...
/* __GAP8 Stop */
  		...
  		/* PULP_GAP10 */	((1<<PULP_RISCV) | (1<<PULP_V2) | (1<<PULP_GAP8) | (1<<PULP_GAP9) | (1<<PULP_GAP10)),
	};
...
/* __GAP8 Stop */
        ...
        else if (strncmp (Text, "gap10", 5) == 0) return PULP_CHIP_GAP10;
...
/* __GAP8 Stop */
        ...
        else if (strncmp (Dup, "gap10", 5) == 0)   { free(Dup); if (Len) *Len = 5; return PULP_GAP10; }
...
/* __GAP8 Stop */
                ...
                case PULP_CHIP_GAP10: return "gap10";
