...
#define gt_ggc_m_31vec_import_export_symbol_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_import_export_symbol_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_import_export_symbol_va_gc_ (void *);
...
#define gt_pch_n_31vec_import_export_symbol_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_import_export_symbol_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_import_export_symbol_va_gc_ (void *);
...
extern void gt_pch_p_28grid_launch_attributes_trees
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_31vec_import_export_symbol_va_gc_
    (void *, void *, gt_pointer_operator, void *);
